  ...
  const fetchMasterData = async () => {
    try {
      ...
      try {
        ...
        const branchesResponse = await fetch(`${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/branches`, {
      ...
      try {
        const usersResponse = await fetch(`${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/users`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
      ...
      try {
        ...
        const brandResponse = await fetch(`${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/brand`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
      ...
      try {
        ...
        const themeResponse = await fetch(`${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/theme`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
      ...
      try {
        ...
        const itemsResponse = await fetch(`${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/items`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
      ...
      try {
        ...
        const occasionsResponse = await fetch(`${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/occasions`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
...
try {
  ...
  let customersUrl = `${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/customers`;
...
const saveBrandDetails = async () => {
  ...
  const saveThemeColor = async () => {
    try {
      ...
      const response = await fetch(`${window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://order-management-fbre.onrender.com'}/api/theme`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
