...
useEffect(() => {
  ...
  <FancyButton text="Save Order" onClick={(e) => handleSubmit(e, 'saved')} />
  <FancyButton text="Hold Order" onClick={(e) => handleSubmit(e, 'held')} />
  <FancyButton text="New Order" onClick={(e) => handleSubmit(e, 'newOrder')} />
</div>
      </div>
